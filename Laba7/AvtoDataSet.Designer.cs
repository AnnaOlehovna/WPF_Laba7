...
namespace Laba7 {
    ...
    public partial class AvtoDataSet : global::System.Data.DataSet {
        ...
        public partial class CarDataTable : global::System.Data.TypedTableBase<CarRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public CarRow AddCarRow(string brand, int year, string color, string model) {
...
namespace Laba7.AvtoDataSetTableAdapters {
    ...
    public partial class CarTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Car] WHERE (([brand] = @Original_brand) AND ([year] = @Origina" +
                "l_year) AND ((@IsNull_color = 1 AND [color] IS NULL) OR ([color] = @Original_col" +
                "or)) AND ([model] = @Original_model) AND ([id] = @Original_id))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Car] ([brand], [year], [color], [model]) VALUES (@brand, @year" +
                ", @color, @model);\r\nSELECT brand, year, color, model, id FROM Car WHERE (id = SC" +
                "OPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Car] SET [brand] = @brand, [year] = @year, [color] = @color, [model] = @model WHERE (([brand] = @Original_brand) AND ([year] = @Original_year) AND ((@IsNull_color = 1 AND [color] IS NULL) OR ([color] = @Original_color)) AND ([model] = @Original_model) AND ([id] = @Original_id));
SELECT brand, year, color, model, id FROM Car WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Laba7.Properties.Settings.Default.AvtoConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT brand, year, color, model, id FROM dbo.Car";
        ...
        public virtual int Delete(string Original_brand, int Original_year, string Original_color, string Original_model, int Original_id) {
        ...
        public virtual int Insert(string brand, int year, string color, string model) {
            if ((brand == null)) {
        ...
        public virtual int Update(string brand, int year, string color, string model, string Original_brand, int Original_year, string Original_color, string Original_model, int Original_id, int id) {
            if ((brand == null)) {
                throw new global::System.ArgumentNullException("brand");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string brand, int year, string color, string model, string Original_brand, int Original_year, string Original_color, string Original_model, int Original_id) {
            return this.Update(brand, year, color, model, Original_brand, Original_year, Original_color, Original_model, Original_id, Original_id);
        }
    }
